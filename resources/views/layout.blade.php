                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            ...
                            @php
                            $information=DB::table('tbl_category')->where('publication_status',1)->get();
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="#">{{$element->category_name}}</a></h4>
                                </div>
                            </div>
                            @endforeach
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    <li><a href="#"> <span class="pull-right">(50)</span>{{$element->manufacture_name}}</a></li>
                                </ul>
                                @endforeach
                            </div>
                        </div><!--/brands_products-->
