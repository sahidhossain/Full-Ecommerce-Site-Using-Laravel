...
<body>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			{{-- 		<li><a href="{{url('/all_product')}}"><i class="icon-dashboard"></i><span class="hidden-tablet">Products</span></a></li> --}}
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">Products Show & Add</span><span class="label label-important"> 2</span></a>
							<ul>
