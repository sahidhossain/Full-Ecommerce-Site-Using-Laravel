			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{url('/update_product/'.$info->product_id)}}" method="post" enctype="multipart/form-data">
							@csrf
						  <fieldset>
				{{-- 			<div class="control-group">
					...
					{{-- 		<div class="control-group">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge " value="{{$info->product_name}}" name="product_name">
							  </div>
							</div>
							...
							<label for="selectError3" class="control-label">Product Category</label>
								<div class="controls">
									<select value="{{$info->category_name}}"id="selectError3" name="category_id">
							...
							<div class="control-group">
								...
								<div class="controls">
									<select value="{{$info->manufacture_name}}" id="selectError3" name="manufacture_id">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input value="{{$info->product_price}}"  type="text" class="input-xlarge " name="product_price">
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input value="{{$info->product_image}}"  type="file" class="input-file uniform_on" id="fileInput" name="product_image">
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input value="{{$info->product_size}}" type="text" class="input-xlarge " name="product_size">
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input value="{{$info->product_color}}"  type="text" class="input-xlarge " name="product_color">
							  </div>
							</div>
